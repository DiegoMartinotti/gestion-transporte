...
describe('DataTable', () => {
  it('should render table with data', () => {
    renderWithProvider(<DataTable columns={mockColumns} data={mockData} />);
  ...
  it('should show empty message when no data', () => {
    renderWithProvider(<DataTable columns={mockColumns} data={[]} emptyMessage="No hay datos" />);

    expect(screen.getByText('No hay datos')).toBeInTheDocument();
  });

  it('should show loading state', () => {
    renderWithProvider(<DataTable columns={mockColumns} data={[]} loading={true} />);
  ...
  it('should filter data with search', () => {
    renderWithProvider(
      <DataTable columns={mockColumns} data={mockData} searchPlaceholder="Buscar..." />
    );

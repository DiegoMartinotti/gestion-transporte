...
describe('SearchInput', () => {
  it('should render search input with placeholder', () => {
    renderWithProvider(
      <SearchInput value="" onChange={() => {}} placeholder="Buscar elementos..." />
    );
  ...
  it('should display current value', () => {
    renderWithProvider(<SearchInput value="test search" onChange={() => {}} />);
  ...
  it('should call onChange when typing', async () => {
    ...
    renderWithProvider(<SearchInput value="" onChange={mockOnChange} />);
  ...
  it('should debounce onChange calls', async () => {
    ...
    renderWithProvider(<SearchInput value="" onChange={mockOnChange} debounceMs={300} />);
  ...
  it('should render clear button when value is not empty', () => {
    renderWithProvider(<SearchInput value="test" onChange={() => {}} />);
  ...
  it('should clear value when clear button is clicked', () => {
    ...
    renderWithProvider(<SearchInput value="test" onChange={mockOnChange} />);
  ...
  it('should not render clear button when value is empty', () => {
    renderWithProvider(<SearchInput value="" onChange={() => {}} />);

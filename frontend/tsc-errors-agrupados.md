...
- Grupo: pages/ordenes-compra (1)
  - frontend/src/pages/ordenes-compra/OrdenesCompraPageOriginal.tsx (1)
- Grupo: pages/reports (1)
  - frontend/src/pages/reports/ReportsPage.tsx (1)
- Grupo: components/validators (4)
  - frontend/src/components/validators/BusinessRuleValidator.tsx (1)
  - frontend/src/components/validators/ViajeValidator.tsx (2)
  - frontend/src/components/validators/DocumentValidatorGeneric.tsx (1)
- Grupo: components/excel (2)
  - frontend/src/components/excel/ReferenceDataSheets.tsx (2)
- Grupo: components/import (1)
  - frontend/src/components/import/hooks/useImportWizard.ts (1)
- Grupo: pages/empresas (1)
  - frontend/src/pages/empresas/EmpresaDetailPage.tsx (1)
- Grupo: components/reports (4)
  - frontend/src/components/reports/ReportHistory.tsx (1)
  - frontend/src/components/reports/components/GroupingTab.tsx (1)
  - frontend/src/components/reports/scheduled/ScheduleCard.tsx (1)
- Grupo: components/preview (1)
  - frontend/src/components/preview/TarifaPreview.tsx (1)
- Grupo: components/versioning (1)
  - frontend/src/components/versioning/TarifaVersioning.tsx (1)

## Tipo: max-lines (19)

- Grupo: components/modals (1)
  - frontend/src/components/modals/ExcelImportSteps.tsx (1)
- Grupo: components/calculators (1)
  - frontend/src/components/calculators/CalculatorComponents.tsx (1)

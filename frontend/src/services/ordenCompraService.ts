...
export class OrdenCompraService {
  ...
  static async getAll(filters?: OrdenCompraFilter, page = 1, limit = 10): Promise<OrdenesCompraResponse> {
  ...
  static async addViaje(id: string, viajeData: { viaje: string; importe: number }): Promise<OrdenCompra> {
  ...
  static async updateViajeImporte(id: string, viajeId: string, importe: number): Promise<OrdenCompra> {

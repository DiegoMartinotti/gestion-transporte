                            ...
                            {result.errores.slice(0, 3).map((error: any, index: number) => (
                                <List.Item key={index}>
                                    <Text size="xs" c="dimmed">
                                        {error.site || error.nombre || error.dominio || error.tramo || `Item ${index + 1}`}: {error.error || error.message}
                                    </Text>
                                </List.Item>
                            ))}
    ...
    return (
        ...
        >
            <Stack gap="md">
                ...
                >
                    <Text size="sm">
                        Selecciona el archivo Excel con las plantillas de corrección completadas 
                ...
                {uploadResult && (
                    <Stack gap="md">
                        ...
                        >
                            <Text size="sm">
                                Los datos han sido importados correctamente. Ahora puedes intentar 
                                importar los viajes nuevamente.
                            </Text>
                        </Alert>
                    </Stack>
                )}

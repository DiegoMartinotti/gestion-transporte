...
// Helper functions
const getOrigenText = (origen: SiteLocation): string => {
...
const getDestinoText = (destino: SiteLocation): string => {
...
const createColumns = (
  ...
  },
  {
    ...
    width: 100,
    render: (viaje: Viaje) => renderActionsColumn(viaje, navigate, onDeleteClick),
  },
];
...
const ViajesTable: React.FC<ViajesTableProps> = ({
  ...
  const columns = createColumns(navigate, onDeleteClick);

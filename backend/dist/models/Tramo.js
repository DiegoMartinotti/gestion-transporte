...
tramoSchema.methods.getTarifaVigente = function (fecha = new Date(), tipo = null) {
    if (tipo) {
        ...
        return this.tarifasHistoricas.find(tarifa => tarifa.tipo === tipo &&
            tarifa.vigenciaDesde <= fecha &&
            tarifa.vigenciaHasta >= fecha);
    }
    else {
        // Buscar cualquier tarifa vigente
        return this.tarifasHistoricas.find(tarifa => tarifa.vigenciaDesde <= fecha &&
            tarifa.vigenciaHasta >= fecha);
    }
};
...
tramoSchema.methods.getTarifasVigentes = function (fecha = new Date()) {
    return this.tarifasHistoricas.filter(tarifa => tarifa.vigenciaDesde <= fecha &&
        tarifa.vigenciaHasta >= fecha);
};
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (this.origen && this.destino && (!this.distancia || this.distancia === 0)) {
                ...
                const origenSite = yield Site.findById(this.origen).select('location');
                const destinoSite = yield Site.findById(this.destino).select('location');
                if (((_b = (_a = origenSite === null || origenSite === void 0 ? void 0 : origenSite.location) === null || _a === void 0 ? void 0 : _a.coordinates) === null || _b === void 0 ? void 0 : _b.length) === 2 &&
                    ((_d = (_c = destinoSite === null || destinoSite === void 0 ? void 0 : destinoSite.location) === null || _c === void 0 ? void 0 : _c.coordinates) === null || _d === void 0 ? void 0 : _d.length) === 2) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (this.tarifasHistoricas && this.tarifasHistoricas.length > 1) {
                ...
                const tarifasOrdenadas = [...this.tarifasHistoricas].sort((a, b) => a.vigenciaDesde - b.vigenciaDesde);
...
tramoSchema.virtual('descripcion').get(function () {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield this.populate('origen destino cliente');

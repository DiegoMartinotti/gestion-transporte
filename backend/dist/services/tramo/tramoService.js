 ...
 */
function _buildSiteMaps() {
    return __awaiter(this, void 0, void 0, function* () {
        // Obtener todos los sitios (esto se hace una sola vez)
        const allSites = yield Site.find({}).select('_id Site codigo location').lean();
 ...
 */
function _processTramoRow(tramoData, indiceTramo, options) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b, _c, _d, _e;
        ...
        try {
            ...
            tramoData.tarifaHistorica.tipo = ((_a = tramoData.tarifaHistorica.tipo) === null || _a === void 0 ? void 0 : _a.toUpperCase()) || 'TRMC';
            // Procesar fechas
            ...
            if (tramoExistente) {
                ...
                for (const tarifaExistente of tramoExistente.tarifasHistoricas) {
                    ...
                    if (tarifaExistente.tipo === nuevaTarifa.tipo &&
                        tarifaExistente.metodoCalculo === nuevaTarifa.metodoCalculo) {
                        if (fechasSuperpuestas(nuevaTarifa.vigenciaDesde, nuevaTarifa.vigenciaHasta, tarifaExistente.vigenciaDesde, tarifaExistente.vigenciaHasta)) {
            ...
            // Caso 2: El tramo no existe, debemos crearlo
                ...
                if ((!nuevoTramo.distancia || nuevoTramo.distancia === 0) &&
                    ((_c = (_b = origenSite === null || origenSite === void 0 ? void 0 : origenSite.location) === null || _b === void 0 ? void 0 : _b.coordinates) === null || _c === void 0 ? void 0 : _c.length) === 2 &&
                    ((_e = (_d = destinoSite === null || destinoSite === void 0 ? void 0 : destinoSite.location) === null || _d === void 0 ? void 0 : _d.coordinates) === null || _e === void 0 ? void 0 : _e.length) === 2) {
                    try {
                        const distanciaKm = yield calcularDistanciaRuta(origenSite.location.coordinates, destinoSite.location.coordinates);
 ...
 */
function bulkImportTramos(clienteId_1, tramosData_1) {
    return __awaiter(this, arguments, void 0, function* (clienteId, tramosData, reutilizarDistancias = true, actualizarExistentes = false) {
        var _a, _b;
        ...
        try {
            ...
            const { sitesMap, sitesMapByCode } = yield _buildSiteMaps();
            // Cargar todos los tramos existentes para este cliente
            const tramosExistentes = yield Tramo.find({
                cliente: clienteId
            });
            ...
            try {
                ...
                for (let i = 0; i < tramosData.length; i++) {
                    ...
                    const resultado = yield _processTramoRow(tramoData, indiceTramo, options);
                    if (resultado.status === 'insert') {
                        ...
                        resultados.errores.push({
                            tramo: indiceTramo,
                            origen: ((_a = resultado.tramoInfo) === null || _a === void 0 ? void 0 : _a.origenNombre) || tramoData.origen,
                            destino: ((_b = resultado.tramoInfo) === null || _b === void 0 ? void 0 : _b.destinoNombre) || tramoData.destino,
                ...
                yield session.withTransaction(() => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (operacionesInsert.length > 0) {
                        yield Tramo.bulkWrite(operacionesInsert, { session });
                        logger.debug(`Insertados ${operacionesInsert.length} tramos nuevos`);
                    }
                    if (operacionesUpdate.length > 0) {
                        yield Tramo.bulkWrite(operacionesUpdate, { session });
 ...
 */
function getTramosByCliente(clienteId_1) {
    return __awaiter(this, arguments, void 0, function* (clienteId, opciones = {}) {
        ...
        const todosLosTramos = yield Tramo.find({ cliente: clienteId })
        ...
        if (desde && hasta && incluirHistoricos === 'true') {
            return yield obtenerTramosHistoricos(todosLosTramos, desde, hasta);
        }
 ...
 */
function obtenerTramosHistoricos(tramos, desde, hasta) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const tramosUnicos = tramos.reduce((mapaTramos, tramo) => {
            ...
            if (!tramo || !tramo.origen || !tramo.destino) {
                logger.warn('Omitiendo tramo sin origen/destino en procesamiento histórico:', tramo === null || tramo === void 0 ? void 0 : tramo._id);
            ...
            const crearClave = (origen, destino, tipo) => `${origen.Site}-${destino.Site}-${tipo || 'TRMC'}`;
            ...
            if (((_a = tramo.tarifasHistoricas) === null || _a === void 0 ? void 0 : _a.length) > 0) {
                // Filtrar tarifas que se superpongan con el rango de fechas solicitado
                const tarifasEnRango = tramo.tarifasHistoricas.filter(tarifa => estaEnRango(tarifa.vigenciaDesde, tarifa.vigenciaHasta));
                ...
                tiposTarifa.forEach(tipo => {
                    ...
                    if (tarifaMasReciente) {
                        ...
                        const tramoConTarifa = Object.assign(Object.assign({}, tramo), { tipo, metodoCalculo: tarifaMasReciente.metodoCalculo, valor: tarifaMasReciente.valor, valorPeaje: tarifaMasReciente.valorPeaje, vigenciaDesde: tarifaMasReciente.vigenciaDesde, vigenciaHasta: tarifaMasReciente.vigenciaHasta, tarifasHistoricas: tramo.tarifasHistoricas });
...
function obtenerTramosActuales(tramos) {
    ...
    `${(origen === null || origen === void 0 ? void 0 : origen.Site) || 'null'}-${(destino === null || destino === void 0 ? void 0 : destino.Site) || 'null'}-${tipo || 'TRMC'}`;
    // Usar reduce para construir el Map de tramos únicos en una sola pasada
    const tramosUnicos = tramos.reduce((mapaTramos, tramo) => {
        var _a;
        // Añadir verificación dentro del reduce para manejar tramos sin origen/destino
        if (!tramo || !tramo.origen || !tramo.destino) {
            logger.warn('Omitiendo tramo sin origen/destino en procesamiento actual:', tramo === null || tramo === void 0 ? void 0 : tramo._id);
            return mapaTramos; // Omitir este tramo
        }
        ...
        if (((_a = tramo.tarifasHistoricas) === null || _a === void 0 ? void 0 : _a.length) > 0) {
            ...
            tramo.tarifasHistoricas.forEach(tarifa => {
                const tramoConTarifa = Object.assign(Object.assign({}, tramo), { tipo: tarifa.tipo || 'TRMC', metodoCalculo: tarifa.metodoCalculo, valor: tarifa.valor, valorPeaje: tarifa.valorPeaje, vigenciaDesde: tarifa.vigenciaDesde, vigenciaHasta: tarifa.vigenciaHasta, tarifasHistoricas: tramo.tarifasHistoricas });
    ...
    const resultado = tramosArray.sort((a, b) => {
        ...
        const origenA = ((_a = a.origen) === null || _a === void 0 ? void 0 : _a.Site) || '';
        const origenB = ((_b = b.origen) === null || _b === void 0 ? void 0 : _b.Site) || '';
        if (origenA < origenB)
            return -1;
        if (origenA > origenB)
            return 1;
        // Si origen es igual, ordenar por destino (manejar null)
        const destinoA = ((_c = a.destino) === null || _c === void 0 ? void 0 : _c.Site) || '';
        const destinoB = ((_d = b.destino) === null || _d === void 0 ? void 0 : _d.Site) || '';
 ...
 */
const createTramosBulk = (tramosData_1, ...args_1) => __awaiter(void 0, [tramosData_1, ...args_1], void 0, function* (tramosData, options = {}) {
    var _a, _b;
    ...
    sitios.forEach(sitio => {
        if (sitio.Site)
            sitiosPorNombre.set(sitio.Site.toLowerCase(), sitio);
        if (sitio.nombre)
    ...
    for (const tramo of tramosData) {
        const origen = sitiosPorNombre.get((_a = tramo.origenNombre) === null || _a === void 0 ? void 0 : _a.toLowerCase());
        const destino = sitiosPorNombre.get((_b = tramo.destinoNombre) === null || _b === void 0 ? void 0 : _b.toLowerCase());
        if (origen && destino) {
            origenesDest.push({ origen: origen._id, destino: destino._id });
            if (origen.Cliente)
                clienteIds.add(origen.Cliente.toString());
            if (destino.Cliente)
                clienteIds.add(destino.Cliente.toString());
        }
    }
    ...
    if (operations.length > 0) {
        try {
            const result = yield Tramo.bulkWrite(operations, { session, ordered: false });
...
//# sourceMappingURL=tramoService.js.map
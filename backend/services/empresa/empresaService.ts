...
class EmpresaService extends BaseService<IEmpresa> {
    ...
    async getByNombre(nombre: string): Promise<IEmpresa | null> {
        ...
        try {
            ...
            const empresa = await this.model.findOne({ 
                nombre: nombre.trim() 
            }).lean().exec();
     ...
     */
    async getEmpresasByTipo(tipo: 'Propia' | 'Subcontratada', opciones: PaginationOptions<IEmpresa> = {}) {
     ...
     * @param options - Opciones de transacción
     */
    protected async afterCreate(empresa: IEmpresa, options: TransactionOptions = {}): Promise<void> {
     ...
     * @param options - Opciones de transacción
     */
    protected async afterUpdate(empresa: IEmpresa, options: TransactionOptions = {}): Promise<void> {
     ...
     * @param options - Opciones de transacción
     */
    protected async beforeDelete(empresa: IEmpresa, options: TransactionOptions = {}): Promise<void> {

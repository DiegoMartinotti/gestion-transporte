 ...
 */
const searchNearby = tryCatch(async (req: express.Request, res: express.Response) => {
    const { lng, lat, maxDistance = '5000' }: NearbyQuery = req.query as NearbyQuery; // maxDistance en metros

...
/**
 * Interface for create/update cliente request
 */
 ...
 */
export const getClientes = async (req: AuthenticatedRequest, res: Response<ApiResponse<ICliente[]>>): Promise<void> => {
    try {
 ...
 */
export const createCliente = async (req: AuthenticatedRequest, res: Response<ApiResponse<ICliente>>): Promise<void> => {
    try {
        // Verificar permisos
 ...
 */
export const updateCliente = async (req: AuthenticatedRequest, res: Response<ApiResponse<ICliente>>): Promise<void> => {
    try {
        ...
        const cliente: ICliente | null = await Cliente.findByIdAndUpdate(
            clienteId,
            req.body,
            { new: true }
        );

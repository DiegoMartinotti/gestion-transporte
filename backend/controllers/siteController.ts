 ...
 */
export const exportSites = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        logger.error('Error al exportar sites:', error);
        res.status(500).json({ success: false, message: 'Error al exportar sites' });
    }
};
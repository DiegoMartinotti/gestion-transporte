 ...
 */
const calcularTarifa = async (req: Request<{}, ApiResponse<TarifaCalculationResult>, TarifaCalculationRequest>, res: Response<ApiResponse<TarifaCalculationResult>>): Promise<void> => {
    try {
        const { 

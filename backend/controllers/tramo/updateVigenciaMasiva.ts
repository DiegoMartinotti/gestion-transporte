 ...
 */
const updateVigenciaMasiva = async (req: Request<{}, ApiResponse<VigenciaUpdateResult>, VigenciaUpdateRequest>, res: Response<ApiResponse<VigenciaUpdateResult>>): Promise<void> => {
    try {
